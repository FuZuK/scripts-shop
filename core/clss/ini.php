...
class ini {
    ...
    public function value_encode($str) {
        $str = str_replace(array("\r", "\n", "\t"), array('\r', '\n', '\t'), $str);
        return htmlentities($str, ENT_QUOTES, 'UTF-8');
    }

    public function value_decode($str) {
        $str = str_replace(array('\r', '\n', '\t'), array("\r", "\n", "\t"), $str);
     ...
     * @return array
     */
    public function openString($string, $sect = false) {
     ...
     * @return array
     */
   public function read($file, $sect = false) {
     ...
     * @return boolean
     */
    public function save($file, $array, $sect = false) {
